...
<div class="container-fluid fluid-nav">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto tnav-left tn-nav">
      <li class="nav-item">
        <a class="nav-link" href="search.html">Việc Làm IT</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="search.html">Tin Tức</a>
      </li>
    ...
    <ul class="navbar-nav mr-auto my-2 my-lg-0 tnav-right tn-nav">
      <li class="nav-item active">
        <a class="nav-link" href="search.html"><i class="fa fa-search" aria-hidden="true"></i> <span class="hidden-text">Tìm kiếm</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="register-employees.html">Đăng Ký</a>
      ...
      <li class="nav-item">
        <a class="nav-link btn-employers" href="login-employers.html" tabindex="-1" aria-disabled="true">Nhà Tuyển Dụng</a>
      </li>
    </ul>
  </div>
</nav>
        ...
        <div class="job-group">
          <div class="job pagi">
              <div class="job-content">
                ...
                <div class="job-desc">
                  <div class="job-title">
                    <a href="#">[HN] 02 Solution Architects–Up to $2000</a>
                  </div>
                  <div class="job-company">
                    <a href="#">Fpt Software</a> | <a href="#" class="job-address"><i class="fa fa-map-marker" aria-hidden="true"></i>Hà Nội</a>
                  </div>
                  ...
                  <div class="job-inf">
                    ...
                    <div class="job-deadline">
                      <span><i class="fa fa-clock-o" aria-hidden="true"></i>  Hạn nộp: <strong>31/12/2023</strong></span>
                    </div>
                  </div>
                </div>
              ...
              <div class="job-content">
                ...
                <div class="job-desc">
                  ...
                  <div class="job-inf">
                    ...
                    <div class="job-deadline">
                      <span><i class="fa fa-clock-o" aria-hidden="true"></i>  Hạn nộp: <strong>31/02/2023</strong></span>
                    </div>
                  </div>
                </div>
                <div class="wrap-btn-appl">
            ...
            <div class="job pagi">
              <div class="job-content">
                ...
                <div class="job-desc">
                  ...
                  <div class="job-company">
                    <a href="#">NVG TECHNOLOGY</a> | <a href="#" class="job-address"><i class="fa fa-map-marker" aria-hidden="true"></i>Hà Nội</a>
                  </div>
            ...
            <div class="item job-latest-item">
              <a href="#" class="job-latest-group">
                ...
                <div class="job-lt-info">
                  <h3>[HN] 02 Solution Architects–Up to $2000 #1</h3>
                  <a class="company" href="#">FPT Software</a>
                  <p class="address" ><i class="fa fa-map-marker pr-1" aria-hidden="true"></i> HÀ NỘI</p>
                </div>
              </a>
            </div>
            <div class="item job-latest-item">
        ...
        <ul class="footer-contact">
          ...
          <li>
            <a href="#">
              ...
              HPC 105, LANDMARK, VĂN KHÊ, HÀ ĐÔNG, HN
            </a>
          </li>
        </ul>
      </div>
